...
namespace Fireasy.Data.Syntax
{
    public class FirebirdSyntax : ISyntaxProvider
    {
        ...
        {
            get { return m_string ?? (m_string = new FirebirdStringSyntax()); }
        }

        public DateTimeSyntax DateTime
        {
            get { return m_datetime ?? (m_datetime = new FirebirdDateTimeSyntax()); }
        }

        public MathSyntax Math
        {
            get { return m_math ?? (m_math = new FirebirdMathSyntax()); }
        }
