...
namespace Fireasy.Data.Syntax
{
    public class AccessSyntax : ISyntaxProvider
    {
        ...
        {
            get { return m_string ?? (m_string = new AccessStringSyntax()); }
        }
        ...
        {
            get { return m_datetime ?? (m_datetime = new AccessDateTimeSyntax()); }
        }
        ...
        {
            get { return m_math ?? (m_math = new AccessMathSyntax()); }
        }
