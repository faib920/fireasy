...
namespace Fireasy.Data.Syntax
{
    ...
    public class SQLiteSyntax : ISyntaxProvider
    {
        ...
        {
            get { return m_string ?? (m_string = new SQLiteStringSyntax()); }
        }
        ...
        {
            get { return m_datetime ?? (m_datetime = new SQLiteDateTimeSyntax()); }
        }
        ...
        {
            get { return m_math ?? (m_math = new SQLiteMathSyntax()); }
        }
