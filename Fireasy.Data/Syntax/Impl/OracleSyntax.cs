...
namespace Fireasy.Data.Syntax
{
    ...
    public class OracleSyntax : ISyntaxProvider
    {
        ...
        {
            get { return m_string ?? (m_string = new OracleStringSyntax()); }
        }
        ...
        {
            get { return m_datetime ?? (m_datetime = new OracleDateTimeSyntax()); }
        }
        ...
        {
            get { return m_math ?? (m_math = new OracleMathSyntax()); }
        }
