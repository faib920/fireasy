...
namespace Fireasy.Data.Syntax
{
    ...
    public class MySqlSyntax : ISyntaxProvider
    {
        ...
        {
            get { return m_string ?? (m_string = new MySqlStringSyntax()); }
        }
        ...
        {
            get { return m_datetime ?? (m_datetime = new MySqlDateTimeSyntax()); }
        }
        ...
        {
            get { return m_math ?? (m_math = new MySqlMathSyntax()); }
        }
