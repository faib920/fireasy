...
namespace Fireasy.Data.Syntax
{
    ...
    public class MsSqlSyntax : ISyntaxProvider
    {
        ...
        {
            get { return m_string ?? (m_string = new MsSqlStringSyntax()); }
        }
        ...
        {
            get { return m_datetime ?? (m_datetime = new MsSqlDateTimeSyntax()); }
        }
        ...
        {
            get { return m_math ?? (m_math = new MsSqlMathSyntax()); }
        }
