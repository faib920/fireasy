...
namespace Fireasy.Data.Syntax
{
    ...
    public class PostgreSqlSyntax : ISyntaxProvider
    {
        ...
        {
            get { return m_string ?? (m_string = new PostgreSqlStringSyntax()); }
        }
        ...
        {
            get { return m_datetime ?? (m_datetime = new PostgreSqlDateTimeSyntax()); }
        }
        ...
        {
            get { return m_math ?? (m_math = new PostgreSqlMathSyntax()); }
        }
