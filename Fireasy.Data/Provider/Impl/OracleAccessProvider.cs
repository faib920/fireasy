...
{
    /// <summary>
    /// Oracle数据库提供者，使用 Oracle.DataAccess 程序集。无法继承此类。
    /// </summary>
    public sealed class OracleAccessProvider : AssemblyProvider
    {
        /// <summary>
        /// 初始化 <see cref="OracleAccessProvider"/> 类的新实例。
        /// </summary>
        public OracleAccessProvider()
            : base("Oracle.DataAccess.Client.OracleClientFactory, Oracle.DataAccess", "Instance")
        {
            ...
            this.RegisterService<IBatcherProvider, OracleAccessBatcher>();
            this.RegisterService<IRecordWrapper, OracleAccessRecordWrapper>();
        }
