...
namespace Fireasy.Common.Aop.Test
{
    /// <summary>
    /// AspectFactoryTests类。
    /// </summary>
    ...
    public class AspectFactoryTests
    {
        ...
        /// </summary>
        [TestMethod()]
        public void SampleCallByParameterTest()
        {
        ...
        /// </summary>
        [TestMethod()]
        public void PrintParametersTest()
        {
            var proxy = AspectFactory.BuildProxy<AspectTester>();
        ...
        /// </summary>
        [TestMethod()]
        public void WithOutParametersComplexTest()
        {
            var proxy = AspectFactory.BuildProxy<AspectTester>();
        ...
        /// </summary>
        [TestMethod()]
        public void IgnoreAnotherExceptionTest()
        {
            var proxy = AspectFactory.BuildProxy<AspectTester>();
        ...
        /// </summary>
        [TestMethod()]
        public void IgnoreExceptionHasReturnValueTest()
        {
            var proxy = AspectFactory.BuildProxy<AspectTester>();
        ...
        /// </summary>
        [TestMethod]
        public void WithCustomInterceptAttributeTest()
        {
            var proxy = AspectFactory.BuildProxy<AspectTester>();
        ...
        [TestMethod]
        public void GlobalInterceptTest()
        {
        ...
        public class AspectTester
        {
            ...
            [Intercept(typeof(SampleInterceptor), false)]
            public virtual DataTable IgnoreAnotherException()
            {
