...
namespace Fireasy.EasyUI
{
    public static class FileBoxExtensions
    {
        ...
        /// <returns></returns>
        public static HtmlHelper FileBox(this HtmlHelper htmlHelper, string exp, FileBoxSettings settings = null)
        {
        ...
        /// <param name="settings">参数选项。</param>
        /// <returns></returns>
        public static HtmlHelper<TModel> FileBox<TModel, TProperty>(this HtmlHelper<TModel> htmlHelper, Expression<Func<TModel, TProperty>> expression, FileBoxSettings settings = null)
        {
            var metadata = new ModelPropertyBinder(expression);
            var propertyName = metadata.PropertyName;
            settings = settings ?? new FileBoxSettings();
