...
namespace Fireasy.EasyUI
{
    public static class TimeSpinnerExtensions
    {
        ...
        /// <returns></returns>
        public static HtmlHelper TimeSpinner(this HtmlHelper htmlHelper, string exp, TimeSpinnerSettings settings = null)
        {
            ...
            htmlHelper.AddStyle("width", "160px")
                .EasyUI("easyui-timespinner", options);
        ...
        /// <param name="settings">参数选项。</param>
        /// <returns></returns>
        public static HtmlHelper<TModel> TimeSpinner<TModel, TProperty>(this HtmlHelper<TModel> htmlHelper, Expression<Func<TModel, TProperty>> expression, TimeSpinnerSettings settings = null)
        {
            var metadata = new ModelPropertyBinder(expression);
            var propertyName = metadata.PropertyName;
            settings = settings ?? new TimeSpinnerSettings();
