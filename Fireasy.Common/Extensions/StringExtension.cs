    ...
    public static class StringExtension
    {
        ...
        public static string ToSimplified(this string source)
        {
            ...
            foreach (char c in source)
            {
                if (c.IsChinese())
                {
                    var index = StringResource.HZ[1].IndexOf(c);
                    output.Append(index > 0 ? StringResource.HZ[0][index] : c);
                }
                else
                {
                    output.Append(c);
        ...
        public static string ToTraditional(this string source)
        {
            ...
            foreach (char c in source)
            {
                if (c.IsChinese())
                {
                    var index = StringResource.HZ[0].IndexOf(c);
                    output.Append(index > 0 ? StringResource.HZ[1][index] : c);
                }
                else
                {
                    output.Append(c);
