...
namespace Fireasy.Data.Entity
{
    ...
    public interface IRepository
    {
        ...
        /// <returns></returns>
        IEntity Get(params object[] primaryValues);
        ...
        /// <param name="entity">要保存的对象。</param>
        /// <returns></returns>
        Task<int> InsertOrUpdateAsync(IEntity entity);
        ...
        /// <param name="logicalDelete">是否为逻辑删除。</param>
        /// <returns></returns>
        Task<int> DeleteAsync(IEntity entity, bool logicalDelete = true);
    ...
    public interface IRepository<TEntity> : IOrderedQueryable<TEntity>, IRepository
    {
        ...
        /// <param name="batchSize">每一个批次插入的实体数量。默认为 1000。</param>
        /// <param name="completePercentage">已完成百分比的通知方法。</param>
        void BatchInsertAsync(IEnumerable<TEntity> entities, int batchSize = 1000, Action<int> completePercentage = null);
        ...
        /// <param name="predicate">用于测试每个元素是否满足条件的函数。</param>
        /// <returns>影响的实体数。</returns>
        Task<int> UpdateAsync(TEntity entity, Expression<Func<TEntity, bool>> predicate);
        ...
        /// <param name="logicalDelete">是否为逻辑删除。</param>
        /// <returns>影响的实体数。</returns>
        Task<int> DeleteAsync(TEntity entity, bool logicalDelete = true);
        ...
        /// <param name="logicalDelete">是否为逻辑删除</param>
        /// <returns>影响的实体数。</returns>
        Task<int> DeleteAsync(Expression<Func<TEntity, bool>> predicate, bool logicalDelete = true);
        ...
        /// <param name="fnOperation"></param>
        /// <returns>影响的实体数。</returns>
        Task<int> BatchAsync(IEnumerable<TEntity> instances, Expression<Func<IRepository<TEntity>, TEntity, int>> fnOperation);
#endif
    }
}
