...
namespace Fireasy.Data.Entity.Linq
{
    ...
    {
        private readonly IEntityQueryProvider m_entityQueryProvider;
        ...
        {
            m_entityQueryProvider = provider;
        }
        ...
        {
            return m_entityQueryProvider.Execute(expression);
        }
        ...
        {
            return (TResult)m_entityQueryProvider.Execute(expression);
        }
        ...
        {
            return m_entityQueryProvider.Translate(expression, option);
        }
    }
}
