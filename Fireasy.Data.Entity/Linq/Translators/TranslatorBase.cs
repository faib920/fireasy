...
namespace Fireasy.Data.Entity.Linq.Translators
{
    ...
    public abstract class TranslatorBase : DbExpressionVisitor, IEntityPersistentEnvironment
    {
        ...
        private IDataSegment m_dataSegment;
        ...
        public InternalContext InternalContext { get; set; }

        protected ISyntaxProvider Syntax
        {
            get
            {
                if (syntax == null)
                {
                    syntax = InternalContext.Database.Provider.GetService<ISyntaxProvider>();
                }
        ...
        protected override Expression VisitConstant(ConstantExpression c)
        {
                ...
                Parameters != null)
            {
                ...
                if (IsStringOrDate(c) || c.Value is PropertyValue)
                {
                    ...
                    c.Value.As<PropertyValue>(p => PropertyValueHelper.Set(p, parameter),
                        () =>
                        {
        ...
        protected virtual void WriteValue(object value)
        {
            ...
            else
            {
                ...
                {
                    WriteValue(((PropertyValue)value).GetStorageValue());
                }
