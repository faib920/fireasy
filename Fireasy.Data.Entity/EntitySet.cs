...
namespace Fireasy.Data.Entity
{
        ...
        where TEntity : class, IEntity
    {
        ...
        Type IEntitySetInternalExtension.EntityType
        {
            get { return typeof(TEntity); }
        }

        IEnumerable<IEntity> IEntitySetInternalExtension.GetDetachedList()
        {
#if N35
        ...
        IEnumerable<IEntity> IEntitySetInternalExtension.GetAttachedList()
        {
#if N35
        ...
        IEnumerable<IEntity> IEntitySetInternalExtension.GetModifiedList()
        {
#if N35
        ...
        void IEntitySetInternalExtension.Reset()
        {
            detachedList.Clear();
        }

        bool IEntitySetInternalExtension.IsNeedClear
        {
